...
extern "C"
{
    ...
    {
        auto&& sceneConstructionEvent$int = FumoCement::toNativePointer<struct NrtUtilitiesEvent>(sceneConstructionEvent);
        auto&& renderingService$int = FumoCement::toNativePointer<struct NrtRenderingService>(renderingService);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtDebugService>(service);
    ...
    {
        return FumoCement::toJavaStringBytes(env, Nrt_getLastError(), returnValueDeletionBehaviour);
    }
    ...
    {
        return FumoCement::toJavaStringBytes(env, Nrt_getLastErrorInternal(), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtLoggingService>(service);
        auto&& message$int = FumoCement::toCppString(env, message);
        auto&& level$int = FumoCement::toNativePrimitive(level);
    ...
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
    ...
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
        auto&& func$int = [](NrtTimestamp proxyParam0, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'U', 'p', 'd', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'U', 'p', 'd', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'U', 'p', 'd', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c', ';', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPrimitive(proxyParam0);
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int);
        };
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1NovelRunner_1UnsubscribeFromUpdateRaw(JNIEnv* env, jclass, jlong runner, jint eventHandlerId)
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
    ...
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
        auto&& func$int = [](void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'S', 'c', 'e', 'n', 'e', 'C', 'o', 'n', 's', 't', 'r', 'u', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'q', 'u', 'e', 's', 't', 'e', 'd', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'S', 'c', 'e', 'n', 'e', 'C', 'o', 'n', 's', 't', 'r', 'u', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'q', 'u', 'e', 's', 't', 'e', 'd', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'N', 'o', 'v', 'e', 'l', 'R', 'u', 'n', 'n', 'e', 'r', '_', 'S', 'u', 'b', 's', 'c', 'r', 'i', 'b', 'e', 'T', 'o', 'S', 'c', 'e', 'n', 'e', 'C', 'o', 'n', 's', 't', 'r', 'u', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'q', 'u', 'e', 's', 't', 'e', 'd', '_', 'f', 'u', 'n', 'c', ';', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
        auto&& eventHandlerId$int = FumoCement::toNativePointer<NrtAtom>(eventHandlerId);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1NovelRunner_1UnsubscribeFromSceneConstructionRequestedRaw(JNIEnv* env, jclass, jlong runner, jint eventHandlerId)
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
        auto&& eventHandlerId$int = FumoCement::toNativePrimitive(eventHandlerId);
    ...
    {
        auto&& runner$int = FumoCement::toNativePointer<struct NrtNovelRunner>(runner);
        auto&& rect$int = FumoCement::toNativePointer<struct NrtImageRect>(rect);
    ...
    {
        auto&& animator$int = FumoCement::toNativePointer<struct NrtSpriteAnimator>(animator);
    ...
    {
        auto&& animator$int = FumoCement::toNativePointer<struct NrtSpriteAnimator>(animator);
        auto&& state$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorState>(state);
    ...
    {
        auto&& frame$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorFrame>(frame);
    ...
    {
        auto&& frame$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorFrame>(frame);
        auto&& texture$int = FumoCement::toNativePointer<struct NrtTexture>(texture);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1SpriteAnimatorFrame_1addFrameEnterRaw(JNIEnv* env, jclass, jlong frame, jlong context)
    {
        ...
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'n', 't', 'e', 'r', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'n', 't', 'e', 'r', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'n', 't', 'e', 'r', '_', 'f', 'u', 'n', 'c', ';', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1SpriteAnimatorFrame_1addFrameExitRaw(JNIEnv* env, jclass, jlong frame, jlong context)
    {
        ...
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'x', 'i', 't', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'x', 'i', 't', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'p', 'r', 'i', 't', 'e', 'A', 'n', 'i', 'm', 'a', 't', 'o', 'r', 'F', 'r', 'a', 'm', 'e', '_', 'a', 'd', 'd', 'F', 'r', 'a', 'm', 'e', 'E', 'x', 'i', 't', '_', 'f', 'u', 'n', 'c', ';', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    {
        auto&& state$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorState>(state);
        auto&& stateTarget$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorState>(stateTarget);
        auto&& vector$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorStateConditionFunctions>(vector);
    ...
    {
        auto&& state$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorState>(state);
        auto&& frames$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorFrameVector>(frames);
    ...
    {
        auto&& vector$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorFrameVector>(vector);
        auto&& frame$int = FumoCement::toNativePointer<struct NrtSpriteAnimatorFrame>(frame);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtAudioService>(service);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtAudioService>(service);
        auto&& handle$int = FumoCement::toNativePointer<struct NrtAudioServiceIterator>(handle);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtRuntimeService>(service);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1RuntimeService_1freeObjectRaw(JNIEnv* env, jclass, jlong service, jint obj)
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtRuntimeService>(service);
    ...
    JNIEXPORT jlong JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1Catalogue_1CreateRaw(JNIEnv* env, jclass, jlong poolId, jlong componentCache, jlong entityCache)
    {
        ...
        auto&& componentCache$int = FumoCement::toNativePointer<struct NrtComponentCache>(componentCache);
        auto&& entityCache$int = FumoCement::toNativePointer<struct NrtEntityCache>(entityCache);
        return FumoCement::toJavaPointer(Nrt_Catalogue_Create(poolId$int, componentCache$int, entityCache$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1Catalogue_1GetComponentViewByIdRaw(JNIEnv* env, jclass, jlong catalogue, jint componentId, jlong outputResult)
    {
        auto&& catalogue$int = FumoCement::toNativePointer<struct NrtCatalogue>(catalogue);
    ...
    JNIEXPORT jlong JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1Catalogue_1GetComponentViewByIdUnsafeRaw(JNIEnv* env, jclass, jlong catalogue, jint componentId)
    {
        auto&& catalogue$int = FumoCement::toNativePointer<struct NrtCatalogue>(catalogue);
        auto&& componentId$int = FumoCement::toNativePrimitive(componentId);
        return FumoCement::toJavaPointer(Nrt_Catalogue_GetComponentViewByIdUnsafe(catalogue$int, componentId$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1Catalogue_1CreateEntityRaw(JNIEnv* env, jclass, jlong catalogue)
    {
        auto&& catalogue$int = FumoCement::toNativePointer<struct NrtCatalogue>(catalogue);
        return FumoCement::toJavaPrimitive(Nrt_Catalogue_CreateEntity(catalogue$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1Catalogue_1DeleteEntityRaw(JNIEnv* env, jclass, jlong catalogue, jint entity)
    {
        auto&& catalogue$int = FumoCement::toNativePointer<struct NrtCatalogue>(catalogue);
    ...
    JNIEXPORT jlong JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentBufferMemoryContainer_1CreateRaw(JNIEnv* env, jclass, jlong poolSize, jlong deleteInstructionState, jlong sizeOfDataTypeInBytes, jlong context)
    {
        ...
        auto&& fnPtr$int = [](void * proxyParam0, const void * proxyParam1, size_t proxyParam2, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'B', 'u', 'f', 'f', 'e', 'r', 'M', 'e', 'm', 'o', 'r', 'y', 'C', 'o', 'n', 't', 'a', 'i', 'n', 'e', 'r', '_', 'C', 'r', 'e', 'a', 't', 'e', '_', 'f', 'n', 'P', 't', 'r'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'B', 'u', 'f', 'f', 'e', 'r', 'M', 'e', 'm', 'o', 'r', 'y', 'C', 'o', 'n', 't', 'a', 'i', 'n', 'e', 'r', '_', 'C', 'r', 'e', 'a', 't', 'e', '_', 'f', 'n', 'P', 't', 'r'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'B', 'u', 'f', 'f', 'e', 'r', 'M', 'e', 'm', 'o', 'r', 'y', 'C', 'o', 'n', 't', 'a', 'i', 'n', 'e', 'r', '_', 'C', 'r', 'e', 'a', 't', 'e', '_', 'f', 'n', 'P', 't', 'r', ';', 'J', 'J', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            ...
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int, proxyParam1$int, proxyParam2$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer>(container);
        auto&& entitiesToDelete$int = FumoCement::toNativePointer<struct NrtEntityIdVector>(entitiesToDelete);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentBufferMemoryContainer_1PushComponentUpdateInstructionRaw(JNIEnv* env, jclass, jlong container, jlong poolId, jint entity, jlong componentData)
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer>(container);
        auto&& poolId$int = FumoCement::toNativePrimitive(poolId);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentBufferMemoryContainer_1GetComponentRaw(JNIEnv* env, jclass, jlong container, jint entity, jlong outputResult)
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer>(container);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    JNIEXPORT jlong JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentBufferMemoryContainer_1GetComponentUnsafeRaw(JNIEnv* env, jclass, jlong container, jint entity)
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer>(container);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
        return FumoCement::toJavaPointer(Nrt_ComponentBufferMemoryContainer_GetComponentUnsafe(container$int, entity$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentBufferMemoryContainer_1HasComponentRaw(JNIEnv* env, jclass, jlong container, jint entity)
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer>(container);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    {
        auto&& view$int = FumoCement::toNativePointer<struct NrtComponentBufferMemoryContainer_ImmutableDataView>(view);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentCache_1RegisterComponentTypeUnsafeRaw(JNIEnv* env, jclass, jlong componentCache, jlong sizeOfDataType, jlong deleteInstructionState, jlong context, jlong outputResult)
    {
        ...
        auto&& updateFnPtr$int = [](void * proxyParam0, const void * proxyParam1, size_t proxyParam2, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'C', 'a', 'c', 'h', 'e', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'T', 'y', 'p', 'e', 'U', 'n', 's', 'a', 'f', 'e', '_', 'u', 'p', 'd', 'a', 't', 'e', 'F', 'n', 'P', 't', 'r'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'C', 'a', 'c', 'h', 'e', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'T', 'y', 'p', 'e', 'U', 'n', 's', 'a', 'f', 'e', '_', 'u', 'p', 'd', 'a', 't', 'e', 'F', 'n', 'P', 't', 'r'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'C', 'a', 'c', 'h', 'e', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'C', 'o', 'm', 'p', 'o', 'n', 'e', 'n', 't', 'T', 'y', 'p', 'e', 'U', 'n', 's', 'a', 'f', 'e', '_', 'u', 'p', 'd', 'a', 't', 'e', 'F', 'n', 'P', 't', 'r', ';', 'J', 'J', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            auto&& proxyParam1$int = FumoCement::toJavaPointer(proxyParam1);
            auto&& proxyParam2$int = FumoCement::toJavaPrimitive(proxyParam2);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1ComponentCache_1GetComponentBufferByIdRaw(JNIEnv* env, jclass, jlong componentCache, jint id, jlong outputResult)
    {
        auto&& componentCache$int = FumoCement::toNativePointer<struct NrtComponentCache>(componentCache);
    ...
    JNIEXPORT void JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1EntityCache_1RemoveEntityRaw(JNIEnv* env, jclass, jlong entityCache, jlong poolId, jint entityToRemove)
    {
        auto&& entityCache$int = FumoCement::toNativePointer<struct NrtEntityCache>(entityCache);
        auto&& poolId$int = FumoCement::toNativePrimitive(poolId);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1EntityIdVector_1InsertRaw(JNIEnv* env, jclass, jlong vector, jint entity)
    {
        auto&& vector$int = FumoCement::toNativePointer<struct NrtEntityIdVector>(vector);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
        return FumoCement::toJavaPrimitive(Nrt_EntityIdVector_Insert(vector$int, entity$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1EntityIdVector_1RemoveRaw(JNIEnv* env, jclass, jlong vector, jint entity)
    {
        auto&& vector$int = FumoCement::toNativePointer<struct NrtEntityIdVector>(vector);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    {
        auto&& container$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer>(container);
    ...
    {
        auto&& view$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_ByteIteratorView>(view);
    ...
    {
        auto&& view$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_ConstByteIteratorView>(view);
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_Iterator>(iterator);
    ...
    {
        auto&& lhs$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_Iterator>(lhs);
        auto&& rhs$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_Iterator>(rhs);
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_ConstIterator>(iterator);
    ...
    {
        auto&& lhs$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_ConstIterator>(lhs);
        auto&& rhs$int = FumoCement::toNativePointer<struct NrtSparseSetMemoryContainer_ConstIterator>(rhs);
    ...
    {
        auto&& systemScheduler$int = FumoCement::toNativePointer<struct NrtSystemScheduler>(systemScheduler);
    ...
    {
        auto&& systemScheduler$int = FumoCement::toNativePointer<struct NrtSystemScheduler>(systemScheduler);
        auto&& systemUpdatePtr$int = [](NrtTimestamp proxyParam0, NrtCatalogueHandle proxyParam1, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'y', 's', 't', 'e', 'm', 'S', 'c', 'h', 'e', 'd', 'u', 'l', 'e', 'r', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'S', 'y', 's', 't', 'e', 'm', '_', 's', 'y', 's', 't', 'e', 'm', 'U', 'p', 'd', 'a', 't', 'e', 'P', 't', 'r'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'y', 's', 't', 'e', 'm', 'S', 'c', 'h', 'e', 'd', 'u', 'l', 'e', 'r', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'S', 'y', 's', 't', 'e', 'm', '_', 's', 'y', 's', 't', 'e', 'm', 'U', 'p', 'd', 'a', 't', 'e', 'P', 't', 'r'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'y', 's', 't', 'e', 'm', 'S', 'c', 'h', 'e', 'd', 'u', 'l', 'e', 'r', '_', 'R', 'e', 'g', 'i', 's', 't', 'e', 'r', 'S', 'y', 's', 't', 'e', 'm', '_', 's', 'y', 's', 't', 'e', 'm', 'U', 'p', 'd', 'a', 't', 'e', 'P', 't', 'r', ';', 'J', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPrimitive(proxyParam0);
            auto&& proxyParam1$int = FumoCement::toJavaPointer(proxyParam1);
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int, proxyParam1$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1UnsafeComponentView_1PushComponentUpdateInstructionRaw(JNIEnv* env, jclass, jlong componentView, jint entity, jlong instructionData)
    {
        auto&& componentView$int = FumoCement::toNativePointer<struct NrtUnsafeComponentView>(componentView);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1UnsafeComponentView_1RemoveComponentRaw(JNIEnv* env, jclass, jlong componentView, jint entity)
    {
        auto&& componentView$int = FumoCement::toNativePointer<struct NrtUnsafeComponentView>(componentView);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
        return FumoCement::toJavaPrimitive(Nrt_UnsafeComponentView_RemoveComponent(componentView$int, entity$int));
    }
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1UnsafeComponentView_1GetComponentRaw(JNIEnv* env, jclass, jlong componentView, jint entity, jlong outputResult)
    {
        auto&& componentView$int = FumoCement::toNativePointer<struct NrtUnsafeComponentView>(componentView);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
        auto&& outputResult$int = FumoCement::toNativePointer<NrtComponentBufferMemoryContainer_ImmutableDataViewHandle>(outputResult);
    ...
    JNIEXPORT jlong JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1UnsafeComponentView_1GetComponentUnsafeRaw(JNIEnv* env, jclass, jlong componentView, jint entity)
    {
        auto&& componentView$int = FumoCement::toNativePointer<struct NrtUnsafeComponentView>(componentView);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtAudioSystem>(service);
    ...
    {
        auto&& system$int = FumoCement::toNativePointer<struct NrtSystemScheduler>(system);
    ...
    {
        auto&& system$int = FumoCement::toNativePointer<struct NrtAudioSystem>(system);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1AudioSystem_1PushEmitterComponentUpdateRaw(JNIEnv* env, jclass, jlong system, jint entity, jlong emitter)
    {
        auto&& system$int = FumoCement::toNativePointer<struct NrtSystemScheduler>(system);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1AudioSystem_1PushEmitterStateComponentUpdateRaw(JNIEnv* env, jclass, jlong system, jint entity, jlong state)
    {
        auto&& system$int = FumoCement::toNativePointer<struct NrtSystemScheduler>(system);
        auto&& entity$int = FumoCement::toNativePrimitive(entity);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtBasicFillRect>(rect);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtBasicFillRect>(rect);
        auto&& inputColourConfig$int = FumoCement::toNativePointer<struct NrtRGBAColour>(inputColourConfig);
    ...
    {
        auto&& camera$int = FumoCement::toNativePointer<struct NrtCamera>(camera);
    ...
    {
        auto&& camera$int = FumoCement::toNativePointer<struct NrtCamera>(camera);
        auto&& callback$int = [](NrtCameraHandle proxyParam0, NrtGeoVector2F proxyParam1, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'a', 'm', 'e', 'r', 'a', '_', 's', 'e', 't', 'F', 'o', 'r', 'c', 'e', 'R', 'e', 's', 'i', 'z', 'e', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'c', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'a', 'm', 'e', 'r', 'a', '_', 's', 'e', 't', 'F', 'o', 'r', 'c', 'e', 'R', 'e', 's', 'i', 'z', 'e', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'c', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'C', 'a', 'm', 'e', 'r', 'a', '_', 's', 'e', 't', 'F', 'o', 'r', 'c', 'e', 'R', 'e', 's', 'i', 'z', 'e', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'c', 'a', 'l', 'l', 'b', 'a', 'c', 'k', ';', 'J', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
    ...
    {
        auto&& fontSet$int = FumoCement::toNativePointer<struct NrtFontSet>(fontSet);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtImageRect>(rect);
        auto&& inputTexture$int = FumoCement::toNativePointer<struct NrtTexture>(inputTexture);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtImageRect>(rect);
        auto&& inputColourTint$int = FumoCement::toNativePointer<struct NrtRGBAColour>(inputColourTint);
    ...
    {
        auto&& windowingService$int = FumoCement::toNativePointer<struct NrtWindowingService>(windowingService);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1RenderingService_1createImageRectWithFileRaw(JNIEnv* env, jclass, jlong renderingService, jlong outputImageRect, jlong transform, jint layer, jbyteArray filePath, jlong colourTint)
    {
        ...
        auto&& colourTint$int = FumoCement::toNativePointer<struct NrtRGBAColour>(colourTint);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1RenderingService_1createBasicFillRectRaw(JNIEnv* env, jclass, jlong renderingService, jlong outputBasicFillRect, jlong transform, jint layer, jlong colourConfig)
    {
        ...
        auto&& transform$int = *FumoCement::toNativePointer<NrtTransform>(transform);
        auto&& layer$int = FumoCement::toNativePrimitive(layer);
        auto&& colourConfig$int = FumoCement::toNativePointer<struct NrtRGBAColour>(colourConfig);
    ...
    {
        auto&& renderingService$int = FumoCement::toNativePointer<struct NrtRenderingService>(renderingService);
        auto&& colour$int = FumoCement::toNativePointer<struct NrtRGBAColour>(colour);
    ...
    {
        auto&& param0$int = FumoCement::toNativePointer<struct NrtRGBAColour>(param0);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtTextRect>(rect);
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtTextRect>(rect);
        return FumoCement::toJavaStringBytes(env, Nrt_TextRect_getText(rect$int), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& rect$int = FumoCement::toNativePointer<struct NrtTextRect>(rect);
        auto&& inputFontSet$int = FumoCement::toNativePointer<struct NrtFontSet>(inputFontSet);
    ...
    {
        auto&& targetTexture$int = FumoCement::toNativePointer<struct NrtTexture>(targetTexture);
        auto&& file$int = FumoCement::toCppString(env, file);
    ...
    {
        auto&& targetTexture$int = FumoCement::toNativePointer<struct NrtTexture>(targetTexture);
        return FumoCement::toJavaStringBytes(env, Nrt_Texture_getTextureFile(targetTexture$int), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtInkService>(service);
    ...
    {
        auto&& story$int = FumoCement::toNativePointer<struct NrtStory>(story);
    ...
    {
        auto&& story$int = FumoCement::toNativePointer<struct NrtStory>(story);
        return FumoCement::toJavaStringBytes(env, Nrt_Story_continue(story$int), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& story$int = FumoCement::toNativePointer<struct NrtStory>(story);
        return FumoCement::toJavaStringBytes(env, Nrt_Story_continueMaximally(story$int), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& object$int = FumoCement::toNativePointer<struct NrtBasicInteractionRect>(object);
    ...
    {
        auto&& object$int = FumoCement::toNativePointer<struct NrtBasicInteractionRect>(object);
        auto&& ptr$int = [](void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'I', 'n', 'p', 'u', 't', '_', 'B', 'a', 's', 'i', 'c', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'c', 't', '_', 'a', 'd', 'd', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', '_', 'p', 't', 'r'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'I', 'n', 'p', 'u', 't', '_', 'B', 'a', 's', 'i', 'c', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'c', 't', '_', 'a', 'd', 'd', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', '_', 'p', 't', 'r'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'I', 'n', 'p', 'u', 't', '_', 'B', 'a', 's', 'i', 'c', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', 'R', 'e', 'c', 't', '_', 'a', 'd', 'd', 'I', 'n', 't', 'e', 'r', 'a', 'c', 't', 'i', 'o', 'n', '_', 'p', 't', 'r', ';', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int);
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtInteractionService>(service);
    ...
    {
        auto&& changeLog$int = FumoCement::toNativePointer<struct NrtKeyStateFrameChangeLog>(changeLog);
    ...
    {
        auto&& lhs$int = FumoCement::toNativePointer<struct NrtKeyStateFrameChangeLog>(lhs);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1KeyStateFrameChangeLog_1compareKeyStateRaw(JNIEnv* env, jclass, jint lhs, jlong rhs)
    {
        ...
        auto&& rhs$int = FumoCement::toNativePointer<struct NrtKeyStateFrameChangeLog>(rhs);
    ...
    {
        auto&& tree$int = FumoCement::toNativePointer<struct NrtQuadTree>(tree);
    ...
    {
        auto&& tree$int = FumoCement::toNativePointer<struct NrtQuadTree>(tree);
        auto&& point$int = FumoCement::toNativePointer<struct NrtQuadTreePoint>(point);
    ...
    {
        auto&& vector$int = FumoCement::toNativePointer<struct NrtPointVector>(vector);
    ...
    {
        auto&& points$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePointArray>(points);
    ...
    {
        auto&& node$int = FumoCement::toNativePointer<struct NrtQuadTreeNode>(node);
    ...
    {
        auto&& pointOne$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePoint>(pointOne);
        auto&& pointTwo$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePoint>(pointTwo);
        auto&& pointThree$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePoint>(pointThree);
        auto&& pointFour$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePoint>(pointFour);
    ...
    {
        auto&& position$int = *FumoCement::toNativePointer<NrtGeoVector2F>(position);
        auto&& node$int = FumoCement::toNativePointer<struct NrtSceneNode>(node);
        auto&& outputPoint$int = FumoCement::toNativePointer<NrtQuadTreeScenePointHandle>(outputPoint);
    ...
    {
        auto&& point$int = FumoCement::toNativePointer<struct NrtQuadTreeScenePoint>(point);
    ...
    {
        auto&& object$int = FumoCement::toNativePointer<struct NrtRenderObject>(object);
    ...
    {
        auto&& node$int = FumoCement::toNativePointer<struct NrtRenderObjectNode>(node);
    ...
    {
        auto&& scene$int = FumoCement::toNativePointer<struct NrtScene>(scene);
    ...
    {
        auto&& scene$int = FumoCement::toNativePointer<struct NrtScene>(scene);
        auto&& nodeToInsert$int = FumoCement::toNativePointer<struct NrtSceneNode>(nodeToInsert);
    ...
    {
        auto&& scene$int = FumoCement::toNativePointer<struct NrtScene>(scene);
        auto&& nodeToRemove$int = FumoCement::toNativePointer<struct NrtSceneNode>(nodeToRemove);
    ...
    {
        auto&& firstNode$int = FumoCement::toNativePointer<struct NrtSceneNode>(firstNode);
        auto&& secondNode$int = FumoCement::toNativePointer<struct NrtSceneNode>(secondNode);
    ...
    {
        auto&& node$int = FumoCement::toNativePointer<struct NrtSceneNode>(node);
        auto&& action$int = [](NrtSceneNodeHandle proxyParam0, void* func$$context) -> void
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n', ';', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int);
        };
    ...
    {
        auto&& node$int = FumoCement::toNativePointer<struct NrtSceneNode>(node);
        auto&& action$int = [](NrtSceneNodeHandle proxyParam0, void* func$$context) -> int32_t
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'W', 'i', 't', 'h', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'a', 'c', 't', 'i', 'o', 'n'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'W', 'i', 't', 'h', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'a', 'c', 't', 'i', 'o', 'n'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'W', 'i', 't', 'h', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'a', 'c', 't', 'i', 'o', 'n', ';', 'J', ')', 'I'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            return FumoCement::toNativePrimitive((func$$context$int->getEnv())->CallStaticIntMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int));
        };
        auto&& context$int = reinterpret_cast<void*>(context);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1SceneNode_1traverseDepthFirstRaw(JNIEnv* env, jclass, jlong node, jlong context)
    {
        ...
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', '_', 'a', 'c', 't', 'i', 'o', 'n', ';', 'J', ')', 'V'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            (func$$context$int->getEnv())->CallStaticVoidMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int);
        };
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1SceneNode_1traverseDepthFirstWithIteratorRaw(JNIEnv* env, jclass, jlong node, jlong context, jlong outputIterator)
    {
        ...
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', '_', 't', 'r', 'a', 'v', 'e', 'r', 's', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', 'W', 'i', 't', 'h', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'a', 'c', 't', 'i', 'o', 'n'>>(func$$context$int->getEnv());
    ...
    {
        auto&& nodeSet$int = FumoCement::toNativePointer<struct NrtSceneNodeSet>(nodeSet);
    ...
    {
        auto&& node$int = FumoCement::toNativePointer<struct NrtSceneNode>(node);
        auto&& func$int = [](NrtSceneNodeHandle proxyParam0, void* func$$context) -> int32_t
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'B', 'r', 'e', 'a', 'd', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c', ';', 'J', ')', 'I'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            return FumoCement::toNativePrimitive((func$$context$int->getEnv())->CallStaticIntMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int));
        };
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSceneNodeBreadthFirstIterator>(iterator);
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSceneNodeBreadthFirstIterator>(iterator);
        auto&& other$int = FumoCement::toNativePointer<struct NrtSceneNodeBreadthFirstIterator>(other);
    ...
    JNIEXPORT jint JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1SceneNodeDepthFirstIterator_1createRaw(JNIEnv* env, jclass, jlong node, jlong context, jlong outputIterator)
    {
        ...
        {
            auto&& func$$context$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context);
            auto&& func$classId$int = FumoCement::getCachedClass<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>>(func$$context$int->getEnv());
            auto&& func$methodId$int = FumoCement::getCachedStaticMethod<FumoCement::TemplateString<'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c'>, FumoCement::TemplateString<'r', 'u', 'n', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k'>, FumoCement::TemplateString<'(', 'L', 'c', 'o', 'm', '/', 'g', 'i', 't', 'h', 'u', 'b', '/', 'n', 'o', 'v', 'e', 'l', 'r', 't', '/', 'i', 'n', 't', 'e', 'r', 'o', 'p', '/', 'N', 'o', 'v', 'e', 'l', 'R', 'T', '$', 'C', 'a', 'l', 'l', 'b', 'a', 'c', 'k', '_', 'N', 'r', 't', '_', 'S', 'c', 'e', 'n', 'e', 'N', 'o', 'd', 'e', 'D', 'e', 'p', 't', 'h', 'F', 'i', 'r', 's', 't', 'I', 't', 'e', 'r', 'a', 't', 'o', 'r', '_', 'c', 'r', 'e', 'a', 't', 'e', '_', 'f', 'u', 'n', 'c', ';', 'J', ')', 'I'>>(func$$context$int->getEnv());
            auto&& func$callbackObject$int = static_cast<FumoCement::FunctionPointerContext*>(func$$context)->globalObjectRef;
            auto&& proxyParam0$int = FumoCement::toJavaPointer(proxyParam0);
            return FumoCement::toNativePrimitive((func$$context$int->getEnv())->CallStaticIntMethod(func$classId$int, func$methodId$int, func$callbackObject$int, proxyParam0$int));
        };
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSceneNodeDepthFirstIterator>(iterator);
    ...
    {
        auto&& iterator$int = FumoCement::toNativePointer<struct NrtSceneNodeDepthFirstIterator>(iterator);
        auto&& other$int = FumoCement::toNativePointer<struct NrtSceneNodeDepthFirstIterator>(other);
    ...
    {
        auto&& timer$int = FumoCement::toNativePointer<struct NrtStepTimer>(timer);
    ...
    {
        auto&& timer$int = FumoCement::toNativePointer<struct NrtStepTimer>(timer);
        auto&& event$int = FumoCement::toNativePointer<struct NrtUtilitiesEventWithTimestamp>(event);
    ...
    {
        return FumoCement::toJavaStringBytes(env, Nrt_getExecutablePath(), returnValueDeletionBehaviour);
    }
    ...
    {
        return FumoCement::toJavaStringBytes(env, Nrt_getExecutableDirPath(), returnValueDeletionBehaviour);
    }
    JNIEXPORT jbyteArray JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1appendFilePathRaw(JNIEnv* env, jclass, jint numberOfArgs, jlong args, jboolean returnValueDeletionBehaviour)
    {
        ...
        return FumoCement::toJavaStringBytes(env, Nrt_appendFilePath(numberOfArgs$int, args$int), returnValueDeletionBehaviour);
    }
    JNIEXPORT jbyteArray JNICALL Java_com_github_novelrt_interop_NovelRT_Nrt_1appendTextRaw(JNIEnv* env, jclass, jint numberOfArgs, jlong args, jboolean returnValueDeletionBehaviour)
    {
        auto&& numberOfArgs$int = FumoCement::toNativePrimitive(numberOfArgs);
        auto&& args$int = FumoCement::toNativePointer<const char *const>(args);
        return FumoCement::toJavaStringBytes(env, Nrt_appendText(numberOfArgs$int, args$int), returnValueDeletionBehaviour);
    }
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtWindowingService>(service);
        auto&& displayNumber$int = FumoCement::toNativePrimitive(displayNumber);
        auto&& windowTitle$int = FumoCement::toCppString(env, windowTitle);
        auto&& windowMode$int = FumoCement::toNativePrimitive(windowMode);
    ...
    {
        auto&& service$int = FumoCement::toNativePointer<struct NrtWindowingService>(service);
        return FumoCement::toJavaStringBytes(env, Nrt_WindowingService_getWindowTitle(service$int), returnValueDeletionBehaviour);
    }
