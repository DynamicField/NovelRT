...
public final class NovelRT {
    ...
    public final class NrtResultKind {
        ...
        public static final int NRT_FAILURE_INVALID_DIRECTORY_PATH = -20;
    }
    ...
    public static native long Nrt_IResourceManagementPluginProvider_GetResourceLoaderRaw(long plugin);
    public static @Pointer("NrtResourceLoaderHandle") long Nrt_IResourceManagementPluginProvider_GetResourceLoader(@Pointer("NrtIResourceManagementPluginProviderHandle") long plugin) {
        long plugin$int = plugin;
        
        var returnValue$int = Nrt_IResourceManagementPluginProvider_GetResourceLoaderRaw(plugin$int);
        return returnValue$int;
    }
